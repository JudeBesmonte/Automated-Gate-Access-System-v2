...
import { DataTableRangeFilter } from "@/core/components/data-table/range-filter"
			...
			>
				...
				>
					<SelectTrigger
						...
						className="h-8 rounded-none border-r-0 bg-background px-2.5 text-xs lowercase hover:bg-accent [&_svg]:hidden"
					>
				...
				<Button
					...
					variant="outline"
					size="sm"
					className="rounded-l-none font-normal"
				...
				<Popover open={showValueSelector} onOpenChange={setShowValueSelector}>
					<PopoverTrigger asChild>
						<Button
							...
							variant="outline"
							size="sm"
							className="rounded-none border-r-0 pl-1.5 pr-3.5 font-normal"
						>
