...
export function SectionCards() {
	...
	return (
		<div className="*:data-[slot=card]:shadow-xs xs:grid-cols-1 grid w-full gap-4 *:data-[slot=card]:bg-gradient-to-t *:data-[slot=card]:from-primary/5 *:data-[slot=card]:to-card dark:*:data-[slot=card]:bg-card sm:grid-cols-2">
